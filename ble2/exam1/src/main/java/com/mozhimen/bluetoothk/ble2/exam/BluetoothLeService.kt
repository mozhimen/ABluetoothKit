...
class BluetoothLeService : Service() {
    ...
    private val bluetoothGattCallback: BluetoothGattCallback = object : BluetoothGattCallback() {
        ...
        override fun onDescriptorWrite(gatt: BluetoothGatt, descriptor: BluetoothGattDescriptor, status: Int) {
            ...
            CBle2.gattCharacteristic_write!!.setValue(Utils.CMMD_QUERY_USER)
            writeCharacteristic(CBle2.gattCharacteristic_write)
        }
    }
    ...
    fun setCharacteristicNotification(gattCharacterisitic: BluetoothGattCharacteristic?, enable: Boolean) {
        ...
        val descriptor = gattCharacterisitic.getDescriptor(CBle2.CLIENT_CHARACTERISTIC_CONFIG_DESCRIPTOR_UUID)
        if (descriptor != null) {
