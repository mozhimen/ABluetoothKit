...
import com.mozhimen.bluetoothk.ble2.exam.databinding.ActivityBluetoothBinding
 ...
 * @Version 1.0
 */
class BluetoothActivity : BaseActivityVB<ActivityBluetoothBinding>() {
    companion object {
    ...
    override fun initView(savedInstanceState: Bundle?) {
        vb.recyHistory.setLayoutManager(LinearLayoutManager(this))
        vb.recyHistory.addItemDecoration(DividerItemDecoration(this, DividerItemDecoration.VERTICAL))
        vb.recyHistory.setAdapter(_baseQuickAdapter)
        ...
        vb.swipeRefresh.setColorSchemeResources(R.color.black)
        ...
        _bluetoothKBle2ScanProxy.apply {
            setBluetoothKScanListener(object : IBluetoothKBleScanListener {
                ...
                override fun onFound(scanResult: ScanResult) {
                    ...
                    if (vb.swipeRefresh.isRefreshing)
