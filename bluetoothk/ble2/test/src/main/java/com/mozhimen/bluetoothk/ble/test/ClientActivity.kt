...
import com.mozhimen.bluetoothk.ble.impls.BluetoothKBleClientProxy
...
class ClientActivity : BaseActivityVDBVM<ActivityClientBinding, ClientViewModel>() {
    ...
    private val _bluetoothKBleClientProxy: BluetoothKBleClientProxy by lazy { BluetoothKBleClientProxy() }
